  ...
  <header class="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 shadow-sm">
    <nav class="container-custom">
      <div class="flex items-center justify-between h-16 md:h-20">
        <!-- Logo (inline SVG for crisper rendering) -->
