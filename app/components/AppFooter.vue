  ...
  <footer class="relative bg-gray-900 text-gray-300 overflow-hidden">
    ...
    <div class="container-custom py-12 md:py-16 relative z-10">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2">
          ...
          <div class="flex space-x-4">
            <a href="https://github.com/philipjlane" target="_blank" rel="noopener noreferrer"
               class="hover:text-white transition-colors" aria-label="GitHub">
            ...
            <a href="https://linkedin.com/in/philipjlane" target="_blank" rel="noopener noreferrer"
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <a href="mailto:hello@elaitch.dev" class="hover:text-white transition-colors">
                hello@elaitch.dev
              </a>
            </li>
          </ul>
      ...
      <div class="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
        <p>&copy; {{ currentYear }} Elaitch. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
